...
class MultiplierPoison extends SpriteComponent with Hitbox,Collidable,HasGameRef<CaptureHalloween>{

  @override
  Future<void>? onLoad() async{
    addHitbox(HitboxRectangle());
    //debugMode = true;
    sprite = await Sprite.load('icons_8_30.png');
    size = Vector2(35,35);
  ...
  void onCollision(Set<Vector2> intersectionPoints, Collidable other) {
    ...
    if (other is CobachaChan) {
      if(gameRef.getEngineGame.getButtonEat.isButtonEatPressed){
        gameRef.remove(this);
        gameRef.getEngineGame.getCobachachan.changeMultiplierCandys();
      }
    }
